...
namespace TNCS
{
    public class TransferTransaction : Transaction
    {
        ...
        public TransferTransaction(byte[] senderPublicKey, string recipient,
            ...
            this(senderPublicKey, recipient, asset, amount, 0.02m, Encoding.UTF8.GetBytes(attachment))
        {                  
        }
        
        public TransferTransaction(byte[] senderPublicKey, string recipient,
            Asset asset, decimal amount, decimal fee = 0.02m, byte[] attachment = null) : 
            this(senderPublicKey, recipient, asset, amount, fee, Assets.TN, attachment)
        {                  
        }
