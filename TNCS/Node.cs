...
namespace TNCS
{
    public class Node
    {
        public const string TestNetHost = "https://apitnetworktest.blackturtle.eu";
        public const string MainNetHost = "https://privatenode.blackturtle.eu";
        ...
        {
            return GetObject($"addresses/balance/{address}").GetDecimal("balance", Assets.TN);
        }

        public decimal GetBalance(string address, int confirmations)
        {
            return GetObject($"addresses/balance/{address}/{confirmations}").GetDecimal("balance", Assets.TN);
        }
